...
\begin{document}
	...
	wobei  $ \phi_{0} = 3.14 $ der erste Messwert der Daten ohne Rauschen sei. Stellen Sie die Lösung
	...
	\section*{Aufgabe 3}
	Implementieren Sie das Levenberg-Marquardt Verfahren für das nichtlineare Ausgleichsproblem
	Welche Werte für die Parameter $ d, \, k $ sind dür die ideale Messung optimal?
