...
\begin{document}
	...
	\section*{Gleichgewichtsreaktion}
		...
		\subsection*{Lösen der Bindungsreaktions-Differentialgleichung}
		...
		\subsection*{Formeln und Tafeln}
			...
			\begin{center}
				...
				\begin{tabular}{ | l | l | l | p{3.75cm} | }
					...
					Viskosität                 & $\eta$      & $Pa \cdot s$, $\frac{kg}{m \cdot s}$ & \\ \hline
					Molekülmasse               & $m_M$       & $kg$, $g$                & \\ \hline
					...
					Strömungsgeschwindigkeit   & $v$         & $\frac{m}{s}$                      
					                           & \\ \hline
		...
		\subsection*{Blutsenkung}
			...
			\begin{mycapequ}[!ht]
				...
				%% 6
				\text{Viskosität}               && \eta         &= 1.73 \cdot 10^{-3} \mathrm{\;Pa\;s} \\
				%% 7
		...
		\newpage
		\subsection*{Zwei Antikörper mit gleicher }
\end{document}