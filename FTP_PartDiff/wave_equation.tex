...
\NewDocumentCommand{\tfillc}{ O{} O{} O{}}{%
    \tikz[baseline, every node/.style={inner sep=2pt,outer sep=0pt}]{
        \node[fill=#2,anchor=base,font=#3] {#1};
    }
}
...
\newcommand{\tsfillo}[1]{\tfillc[#1][orange!40][\scriptsize]}
\newcommand{\tsfillg}[1]{\tfillc[#1][Green!20][\scriptsize]}
\newcommand{\tsfilly}[1]{\tfillc[#1][yellow!40][\scriptsize]}
\newcommand{\tsfillr}[1]{\tfillc[#1][red!20][\scriptsize]}
\newcommand{\tsfillv}[1]{\tfillc[#1][Violet!20][\scriptsize]}
\newcommand{\tsfillt}[1]{\tfillc[#1][Turquoise!20][\scriptsize]}
\newcommand{\tsfillgr}[1]{\tfillc[#1][Gray!20][\scriptsize]}
